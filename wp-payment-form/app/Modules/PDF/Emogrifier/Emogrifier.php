...
class Emogrifier
{
    ...
    private function clearCache($key)
    {
        ...
        if (!in_array($key, $allowedCacheKeys, true)) {
            // phpcs:ignore WordPress.Security.EscapeOutput.ExceptionNotEscaped -- $key is internal and not displayed to end users.
    ...
    )
    {
        ...
        if ($selector !== '') {
            throw new \InvalidArgumentException(
                // phpcs:ignore WordPress.Security.EscapeOutput.ExceptionNotEscaped -- Exception message for internal debugging, not sent to browser.
