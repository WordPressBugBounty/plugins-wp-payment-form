...
<div class="add_on_modules">
    ...
    <div style="padding: 45px 20px;display: block;" class="modules_body">
        ...
        <div style="text-align: center" class="install_wrapper">
            ...
            <a class="button-primary" href="<?php echo esc_url($install_url); ?>">Install Fluent PDF Addon</a>
        </div>
        <?php else:
            do_action('wppayform_addons_page_render_fluent_pdf_settings');
        endif; ?>
