<div class="wpf_payment_info">
    ...
    <div class="wpf_payment_info_item wpf_payment_info_item_date">
        ...
        <div class="wpf_item_value"><?php echo esc_html(wp_date(get_option('date_format'), strtotime($submission->created_at))); ?></div>
    </div>
    <?php if ($submission->payment_total) : ?>
        <?php
        $wppayform_currency_setting = \WPPayForm\App\Services\GeneralSettings::getGlobalCurrencySettings();
        ...
        <div class="wpf_payment_info_item wpf_payment_info_item_total">
            ...
            <div class="wpf_item_value"><?php echo ($submission->payment_total > 0) ? esc_html(wpPayFormFormattedMoney($submission->payment_total, $wppayform_currency_setting)) : esc_html_e('pending', 'wp-payment-form'); ?></div>
        </div>
    <?php endif; ?>
    <?php if ($submission->payment_method) : 
         $wppayform_payment_method = lcfirst(strtolower(esc_attr($submission->payment_method))); 
         $wppayform_image_url = WPPAYFORM_URL . 'assets/images/gateways/' . $wppayform_payment_method .'.svg';
        ?>
        <div class="wpf_payment_info_item wpf_payment_info_item_payment_method">
            ...
            <div class="wpf_item_value"><strong><?php echo esc_html(ucfirst($submission->payment_method)); ?></strong></div>
    ...
    <?php if ($submission->payment_status && $submission->order_items) : 
        ...
        <div class="wpf_payment_info_item wpf_payment_info_item_payment_status">
            ...
            <div class="wpf_item_content <?php echo esc_attr($wppayform_payment_status) ?>">
                <div class="wpf_item_value"><?php echo esc_html(ucfirst($submission->payment_status)); ?></div>
            </div>
        </div>
    <?php endif; ?>
</div>
